package cohort5860.runner;

import cohort5860.model.FixerApiResponse;
import cohort5860.service.CurrencyConverterService;
import org.springframework.boot.CommandLineRunner;
import org.springframework.stereotype.Component; // <-- Добавьте этот импорт
...
public class ConsoleRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Удалили проверку на response.isSuccess() здесь,
        // так как она теперь выполняется в CurrencyConverterService.getLatestRates()
        // и в случае неуспеха возвращается Optional.empty().
        // Если Optional не пуст, значит, response.isSuccess() уже true.
